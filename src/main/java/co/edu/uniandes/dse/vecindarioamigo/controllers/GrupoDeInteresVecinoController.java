...
public class AuthorBookController {
	...
	public VecinoDetailDTO getBook(@PathVariable("grupoDeInteresId") Long grupoDeInteresId, @PathVariable("vecinoId") Long vecinoId)
	 ...
	 * @return JSONArray {@link VecinoDetailDTO} - Los libros encontrados en el autor.
	 *         Si no hay ninguno retorna una lista vacía.
	 */
	@GetMapping(value = "/{grupoDeInteresId}/vecinos")
	@ResponseStatus(code = HttpStatus.OK)
	public List<VecinoDetailDTO> getBooks(@PathVariable("grupoDeInteresId") Long grupoDeInteresId) throws EntityNotFoundException {
	...
	@ResponseStatus(code = HttpStatus.OK)
	public VecinoDetailDTO addBook(@PathVariable("grupoDeInteresId") Long grupoDeInteresId, @PathVariable("vecinoId") Long vecinoId)
	 ...
	 *
	 * @param grupoDeInteresId El ID del autor al cual se le va a asociar el libro
	 * @param vecinos    JSONArray {@link VecinoDTO} - La lista de libros que se desea
	 *                 guardar.
	 * @return JSONArray {@link VecinoDetailDTO} - La lista actualizada.
	 */
	@PutMapping(value = "/{grupoDeInteresId}/vecinos")
	@ResponseStatus(code = HttpStatus.OK)
	public List<VecinoDetailDTO> replaceBooks(@PathVariable("grupoDeInteresId") Long grupoDeInteresId, @RequestBody List<VecinoDTO> vecinos)
			throws EntityNotFoundException {
	 ...
	 *
	 * @param grupoDeInteresId El ID del autor al cual se le va a desasociar el libro
	 * @param vecinoId   El ID del libro que se desasocia
	 */
	@DeleteMapping(value = "/{grupoDeInteresId}/vecinos/{vecinoId}")
	@ResponseStatus(code = HttpStatus.NO_CONTENT)
	public void removeBook(@PathVariable("grupoDeInteresId") Long grupoDeInteresId, @PathVariable("vecinoId") Long vecinoId)
			throws EntityNotFoundException {
