...
public class ComentarioCentroComercioalController {
	 ...
	 * @param centroComercialId Identificador del autor que se desea guardar. Este
	 *                          debe ser
	...
	public CentroComercialDTO addAuthor(@PathVariable("comentarioId") Long comentarioId,
			@PathVariable("centroComercialId") Long publicacionId)
			throws EntityNotFoundException {
		CentroComercialEntity publicacionEntity = comentarioCentroComercialService.addCentroComercial(publicacionId,
				comentarioId);
	...
	@ResponseStatus(code = HttpStatus.OK)
	public CentroComercialDetailDTO getAuthor(@PathVariable("comentarioId") Long comentarioId)
			throws EntityNotFoundException {
